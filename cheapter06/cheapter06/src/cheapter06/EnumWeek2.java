 ...
 * 컴퓨터의 날짜, 요일, 시간을 얻기 위해Calendar 클래스 필요
 * Calendar,getInstance() Calendar 객체 얻기
 * today는 스택 영역에 생성, Week 객체는 열 영역에 생성, Week.SUNDAY 는 메소드 영역에 
...
public class EnumWeek2 {
	...
	public static void main(String[] args) {
		...
		int week=cal.get(Calendar.DAY_OF_WEEK);//월(1)~토(7)까지 숫자 리턴
